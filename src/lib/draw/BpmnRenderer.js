...
export default function BpmnRenderer(
  ...
  var defaultFillColor = '#F7F7F7',
    defaultStrokeColor = '#DDDEE1',
    labelStrokeColor = '#282828';
  ...
  function renderEmbeddedLabel(parentGfx, element, align) {
    ...
    return renderLabel(parentGfx, semantic.name, {
      ...
      padding: 5,
      style: {
        fill: getStrokeColor(element, labelStrokeColor)
      }
    });
  }
